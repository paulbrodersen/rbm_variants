...
experiments.append([DirectedRBM,                dict(scale_forward_weights_by=0.1, scale_backward_weights_by=1.0, **network_layout), dict(cd=3, eta=0.01, update_forward=True,  update_backward=False), '#d62728',   r'Directed RBM with constant w$_{B}$',             'f3_directed_rbm_with_constant_w_B'])
experiments.append([DirectedRBM,                dict(scale_forward_weights_by=0.1, scale_backward_weights_by=1.0, **network_layout), dict(cd=3, eta=0.01, update_forward=False, update_backward=False), 'lightgray', r'Directed RBM with constant w$_{F}$ and w$_{B}$', 'f3_directed_rbm_with_constant_w_B'])
